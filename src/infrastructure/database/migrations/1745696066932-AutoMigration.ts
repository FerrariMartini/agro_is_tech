...
export class AutoMigration1745696066932 implements MigrationInterface {
  name = 'AutoMigration1745696066932';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "properties" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "city" character varying NOT NULL, "state" character varying NOT NULL, "total_area" numeric(10,2) NOT NULL, "arable_area" numeric(10,2) NOT NULL, "vegetation_area" numeric(10,2) NOT NULL, "producer_id" uuid NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, CONSTRAINT "PK_2d83bfa0b9fcd45dee1785af44d" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "properties" ADD CONSTRAINT "FK_69f6c79c4f49c1bb12a473bdd16" FOREIGN KEY ("producer_id") REFERENCES "producers"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "harvests" ADD CONSTRAINT "FK_b9dfcfb6efb97bafbbe1fc84d9f" FOREIGN KEY ("property_id") REFERENCES "properties"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "crops" ADD CONSTRAINT "FK_33def18beba78449f5f4e99aa2f" FOREIGN KEY ("harvest_id") REFERENCES "harvests"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "harvests" DROP CONSTRAINT "FK_b9dfcfb6efb97bafbbe1fc84d9f"`,
    );
    await queryRunner.query(
      `ALTER TABLE "properties" DROP CONSTRAINT "FK_69f6c79c4f49c1bb12a473bdd16"`,
    );
